...
__all__ = ['defaults', 'newchk', 'patch', 'chk', 'tensor', 'add_docs', 'docs', 'custom_dir', 'is_iter', 'coll_repr',
           'GetAttr', 'L', 'ifnone', 'mk_class', 'noop', 'noops', 'tuplify', 'replicate', 'uniqueify', 'setify',
           'is_listy', 'range_of', 'mask2idxs', 'apply', 'to_detach', 'to_half', 'to_float', 'to_device', 'to_cpu',
           'item_find', 'find_device', 'find_bs', 'compose', 'mapper', 'partialler', 'sort_by_run', 'add_props',
           'make_cross_image', 'opt_call', 'all_union', 'all_disjoint', 'camel2snake', 'trainable_params',
           'PrettyString']
